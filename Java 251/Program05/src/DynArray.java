public class DynArray {
	...
	public double remove() { // Call removeAt() with the last used index as a parameter
	...
	private boolean timeToGrow() {
		return this.elements() == this.arraySize(); // Underlying array is full
	}

	private boolean timeToShrink() { // Underlying array is less than half full
		return (this.elements() < (this.arraySize() / 2));
	}
